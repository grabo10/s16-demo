    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h3 mb-4 text-gray-800">Add Owner</h1>
                <form:form method="post" modelAttribute="owner" class="user">
                    ...
                    <div class="form-group">
                        ...
                        <form:checkboxes path="realEstates" multiple="true" items="${realEstates}" itemLabel="street" itemValue="id" cssClass="form-control form-control-user" id="realEstateId"/>
                        <form:errors path="realEstates" cssClass="text-danger"/>
                    </div>
